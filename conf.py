...
BLOG_AUTHOR = "Wei-Cheng Pan"
BLOG_TITLE = "「　」"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://legnaleurc.github.io/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "legnaleurc@gmail.com"
BLOG_DESCRIPTION = "へんじがない、ただのしかばねのようだ"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('http://about.me/legnaleurc', 'About me', 'icon-user'),
        ('https://twitter.com/__CA__', 'My Twitter', 'icon-twitter'),
        ('https://github.com/legnaleurc', 'My Github', 'icon-github'),
    ),
}
